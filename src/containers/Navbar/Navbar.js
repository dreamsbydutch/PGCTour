            ...
            <Container className='navbar-container'>
                ...
                <Navbar.Collapse id="responsive-navbar-nav">
                    <Nav className="mr-auto">
                        ...
                        <Nav.Link aria-controls="basic-navbar-nav" href="/pgctour#/standings">Standings</Nav.Link>
                        <Nav.Link aria-controls="basic-navbar-nav" href="/pgctour#/golferstats">Golfer Stats</Nav.Link>
