...
function Rulebook() {
    ...
    return (
        <div className='rulescontainer'>
            ...
            <div className="rulebook-rules">Everyone chooses 2 golfers from each of the 5 groupings to create your 10 golfer team for the tournament. You will make new picks and have a new team for each tournament on the schedule.</div>
            ...
            <div className="rulebook-rules">Major Champions will win $75</div>
            <div className="rulebook-rules">Inviational Champions will win $50</div>
            <div className="rulebook-rules">Standard Champions will win $25</div>
