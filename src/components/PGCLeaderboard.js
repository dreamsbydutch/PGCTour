...
export function PGCLeaderboardItem(props) {
    ...
    function PGCLeaderboardItemMini(props) {
        return (
            <div className='grid grid-flow-row grid-cols-10 text-center py-1'>
                <div className='font-varela place-self-center text-sm col-span-2'>{props.info.Score === "+100" ? "CUT" : props.info.ShowRk}&nbsp;&nbsp;&nbsp;{getRkChange(props.info.RkChange)}</div>
                ...
                <div className='font-varela place-self-center text-2xs col-span-1'>{props.live ? formatScore(props.info.Today) : +props.info.Points === 0 ? "-" : props.info.Points}</div>
                <div className='font-varela place-self-center text-2xs col-span-1 whitespace-nowrap'>{props.live ? props.info.Thru : formatMoney(props.info.Earnings)}</div>
            </div>
        )
    }
    function PGCLeaderboardItemPhone(props) {
        return (
            <div className='grid grid-flow-row grid-cols-10 text-center py-1'>
                ...
                <div className='font-varela place-self-center text-sm col-span-2'>{formatScore(props.info.Score)}</div>
                <div className='font-varela place-self-center text-xs col-span-1'>{props.live ? formatScore(props.info.Today) : +props.info.Points === 0 ? "-" : props.info.Points}</div>
                <div className='font-varela place-self-center text-xs col-span-1 whitespace-nowrap'>{props.live ? props.info.Thru : formatMoney(props.info.Earnings)}</div>
            </div>
        )
    }
    function PGCLeaderboardItemTablet(props) {
        return (
            <div className='grid grid-flow-row grid-cols-10 text-center py-1'>
                <div className='font-varela place-self-center text-base col-span-2'>{props.info.Score === "+100" ? "CUT" : props.info.ShowRk}&nbsp;&nbsp;&nbsp;{getRkChange(props.info.RkChange)}</div>
                <div className='font-varela place-self-center text-lg col-span-4'>{props.info.Name}</div>
                <div className='font-varela place-self-center text-base col-span-2'>{formatScore(props.info.Score)}</div>
                <div className='font-varela place-self-center text-sm col-span-1'>{props.live ? formatScore(props.info.Today) : +props.info.Points === 0 ? "-" : props.info.Points}</div>
                <div className='font-varela place-self-center text-sm col-span-1 whitespace-nowrap'>{props.live ? props.info.Thru : formatMoney(props.info.Earnings)}</div>
            </div>
        )
    }
    function PGCLeaderboardItemDesktop(props) {
        return (
            <div className='grid grid-flow-row grid-cols-12 text-center py-1'>
                <div className='font-varela place-self-center text-sm col-span-1'>{props.info.Score === "+100" ? "CUT" : props.info.ShowRk}&nbsp;&nbsp;{getRkChange(props.info.RkChange)}</div>
                ...
                <div className='font-varela place-self-center text-sm col-span-1'>{props.live ? formatScore(props.info.Today) : +props.info.Points === 0 ? "-" : props.info.Points}</div>
                <div className='font-varela place-self-center text-xs col-span-1 whitespace-nowrap'>{props.live ? props.info.Thru : formatMoney(props.info.Earnings)}</div>
                <div className='font-varela place-self-center text-xs col-span-2'>{`${props.info.R1}${props.info.R2 === "" ? "" : " - "}${props.info.R2}${props.info.R3}${props.info.R4 === "" ? "" : " - "}${props.info.R4}`}</div>
...
function PGCLeaderboardItemInfo(props) {
    return (
        <div className="mt-1 mb-6 mx-auto">
            <TeamRounds {...props} />
            <PGCTeamTable {...props} />
            {props.info.tourneyID > 1 && props.info.tourneyID <= 16 && props.info.R4 === "" &&
                <ProjStandings {...props} />
            }
        </div>
    )
...
function TeamRounds(props) {
    ...
    return (
        <>{window.width < 550 ?
            <TeamRoundsPhone {...props} />
            :
            window.width < 925 ?
                <TeamRoundsTablet {...props} />
                :
                <></>
        }</>
    )
    ...
    function PGCTeamTableMini(props) {
        ...
        return (
            <table className="text-center w-11/12 mx-auto mb-2 table-auto">
                ...
                <tbody className={`bg-gray-50 ${(props.info.R2 !== "") ? '[&>*:nth-child(5)]:border-b [&>*:nth-child(5)]:border-gray-400' : ''}`}>
                    {golfers?.map(obj => {
                        return (
                            <tr className={`${((
                                (props.info.R1 !== "-") && 
                                ...
                                (+(obj.currentPos.replace("T", "")) > 65)) || obj.currentPos === "CUT" || obj.currentPos === "WD" || obj.currentPos === "DQ") ? 'text-gray-400' : 'text-gray-800'}`}>
                                <td className="text-xs">{obj.currentPos}</td>
                                <td className="text-xs">{obj.playerName}</td>
                                <td className="text-xs">{obj.currentPos === "CUT" || obj.currentPos === "WD" || obj.currentPos === "DQ" ? "-" : formatScore(obj.currentScore)}</td>
                                <td className="text-xs">{obj.currentPos === "CUT" || obj.currentPos === "WD" || obj.currentPos === "DQ" ? "-" : `${formatScore(obj.today)} (${formatThru(obj.thru,(props.info.R1 === "" ? obj.r1TeeTime : props.info.R2 === "" ? obj.r2TeeTime : props.info.R3 === "" ? obj.r3TeeTime : props.info.R4 === "" ? obj.r4TeeTime : ""))})`}</td>
                            </tr>
                        )
                    })}
                </tbody>
                    ...
                    {golfers?.map(obj => {
                        return (
                            <tr className={`${((
                                ...
                                <td className="text-sm">{obj.currentPos === "CUT" || obj.currentPos === "WD" || obj.currentPos === "DQ" ? "-" : formatScore(obj.currentScore)}</td>
                                <td className="text-sm">{obj.currentPos === "CUT" || obj.currentPos === "WD" || obj.currentPos === "DQ" ? "-" : `${formatScore(obj.today)} (${formatThru(obj.thru,(props.info.R1 === "" ? obj.r1TeeTime : props.info.R2 === "" ? obj.r2TeeTime : props.info.R3 === "" ? obj.r3TeeTime : props.info.R4 === "" ? obj.r4TeeTime : ""))})`}</td>
                            </tr>
                        )
                    })}
                </tbody>
                    ...
                    {golfers?.map(obj => {
                        return (
                            <tr className={`${((
                                ...
                                <td className="text-sm">{obj.currentPos === "CUT" || obj.currentPos === "WD" || obj.currentPos === "DQ" ? "-" : formatScore(obj.currentScore)}</td>
                                <td className="text-sm">{obj.currentPos === "CUT" || obj.currentPos === "WD" || obj.currentPos === "DQ" ? "-" : `${formatScore(obj.today)} (${formatThru(obj.thru,(props.info.R1 === "" ? obj.r1TeeTime : props.info.R2 === "" ? obj.r2TeeTime : props.info.R3 === "" ? obj.r3TeeTime : props.info.R4 === "" ? obj.r4TeeTime : ""))})`}</td>
                                <td className="text-sm">{obj.currentPos === "CUT" || obj.currentPos === "WD" || obj.currentPos === "DQ" ? "-" : `${Math.round((props.info.R2 === "" ? obj.makeCut : obj.topTen)*1000)/10}%`}</td>
                                <td className="text-sm">{obj.currentPos === "CUT" || obj.currentPos === "WD" || obj.currentPos === "DQ" ? "-" : `${Math.round((props.info.R2 === "" ? obj.topTen : obj.win)*1000)/10}%`}</td>
                            </tr>
                        )
                    })}
                </tbody>
                    ...
                    {golfers?.map(obj => {
                        return (
                            <tr className={`${((
                                ...
                                <td className="text-base">{obj.currentPos === "CUT" || obj.currentPos === "WD" || obj.currentPos === "DQ" ? "-" : formatScore(obj.currentScore)}</td>
                                <td className="text-base">{obj.currentPos === "CUT" || obj.currentPos === "WD" || obj.currentPos === "DQ" ? "-" : `${formatScore(obj.today)} (${formatThru(obj.thru,(props.info.R1 === "" ? obj.r1TeeTime : props.info.R2 === "" ? obj.r2TeeTime : props.info.R3 === "" ? obj.r3TeeTime : props.info.R4 === "" ? obj.r4TeeTime : ""))})`}</td>
                                <td className="text-base">{obj.currentPos === "CUT" || obj.currentPos === "WD" || obj.currentPos === "DQ" ? "-" : `${Math.round((props.info.R2 === "" ? obj.makeCut : obj.topTen)*1000)/10}%`}</td>
                                <td className="text-base">{obj.currentPos === "CUT" || obj.currentPos === "WD" || obj.currentPos === "DQ" ? "-" : `${Math.round((props.info.R2 === "" ? obj.topTen : obj.win)*1000)/10}%`}</td>
                            </tr>
                        )
                    })}
                </tbody>
        ...
        return (
            <div className='w-3/6 mx-auto bg-gray-50 rounded-lg'>
                ...
                <div className="mx-auto grid grid-cols-2 mb-1">
                    <div className={`font-varela py-1 text-sm text-center place-self-center ${+(props.standings.ShowRk[0] === "T" ? props.standings.ShowRk.slice(1) : props.standings.ShowRk) <=15 ? 'text-yellow-700 font-bold' : +(props.standings.ShowRk[0] === "T" ? props.standings.ShowRk.slice(1) : props.standings.ShowRk) <=30 ? 'text-zinc-700 font-semibold' : 'text-rose-800'}`}>
                        {props.standings.ShowRk[0] === "T" ? "T" + addRankingSuffix(props.standings.ShowRk.slice(1)) : addRankingSuffix(props.standings.ShowRk)}
                    </div>
                    <div className={`font-varela py-1 text-sm text-center place-self-center ${+(props.standings.ProjRk[0] === "T" ? props.standings.ProjRk.slice(1) : props.standings.ProjRk) <=15 ? 'text-yellow-700 font-bold' : +(props.standings.ProjRk[0] === "T" ? props.standings.ProjRk.slice(1) : props.standings.ProjRk) <=30 ? 'text-zinc-700 font-semibold' : 'text-rose-800'}`}>
    ...
    function ProjStandingsTablet(props) {
        return (
            <div className='w-4/6 mx-auto bg-gray-50 rounded-lg'>
                ...
                <div className="mx-auto grid grid-cols-2 mb-1">
                    <div className={`font-varela py-1 text-base text-center place-self-center ${+(props.standings.ShowRk[0] === "T" ? props.standings.ShowRk.slice(1) : props.standings.ShowRk) <=15 ? 'text-yellow-700 font-bold' : +(props.standings.ShowRk[0] === "T" ? props.standings.ShowRk.slice(1) : props.standings.ShowRk) <=30 ? 'text-zinc-700 font-semibold' : 'text-rose-800'}`}>
                        {`${props.standings.ShowRk[0] === "T" ? "T" + addRankingSuffix(props.standings.ShowRk.slice(1)) : addRankingSuffix(props.standings.ShowRk)} - ${props.standings.Points} pts`}
                    </div>
                    <div className={`font-varela py-1 text-base text-center place-self-center ${+(props.standings.ProjRk[0] === "T" ? props.standings.ProjRk.slice(1) : props.standings.ProjRk) <=15 ? 'text-yellow-700 font-bold' : +(props.standings.ProjRk[0] === "T" ? props.standings.ProjRk.slice(1) : props.standings.ProjRk) <=30 ? 'text-zinc-700 font-semibold' : 'text-rose-800'}`}>
                        {`${props.standings.ProjRk[0] === "T" ? "T" + addRankingSuffix(props.standings.ProjRk.slice(1)) : addRankingSuffix(props.standings.ProjRk)} - ${props.standings.ProjPoints} pts`}
                    </div>
                </div>
            </div>
        )
    ...
    function ProjStandingsDesktop(props) {
        return (
            <div className='w-4/6 mx-auto bg-gray-50 rounded-lg'>
                ...
                <div className="mx-auto grid grid-cols-2 mb-1">
                    <div className={`font-varela py-1 text-lg text-center place-self-center ${+(props.standings.ShowRk[0] === "T" ? props.standings.ShowRk.slice(1) : props.standings.ShowRk) <=15 ? 'text-yellow-700 font-bold' : +(props.standings.ShowRk[0] === "T" ? props.standings.ShowRk.slice(1) : props.standings.ShowRk) <=30 ? 'text-zinc-700 font-semibold' : 'text-rose-800'}`}>
                        {`${props.standings.ShowRk[0] === "T" ? "T" + addRankingSuffix(props.standings.ShowRk.slice(1)) : addRankingSuffix(props.standings.ShowRk)} - ${props.standings.Points} pts`}
                    </div>
                    <div className={`font-varela py-1 text-lg text-center place-self-center ${+(props.standings.ProjRk[0] === "T" ? props.standings.ProjRk.slice(1) : props.standings.ProjRk) <=15 ? 'text-yellow-700 font-bold' : +(props.standings.ProjRk[0] === "T" ? props.standings.ProjRk.slice(1) : props.standings.ProjRk) <=30 ? 'text-zinc-700 font-semibold' : 'text-rose-800'}`}>
                        {`${props.standings.ProjRk[0] === "T" ? "T" + addRankingSuffix(props.standings.ProjRk.slice(1)) : addRankingSuffix(props.standings.ProjRk)} - ${props.standings.ProjPoints} pts`}
                    </div>
                </div>
            </div>
