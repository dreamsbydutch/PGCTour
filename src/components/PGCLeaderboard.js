...
function PGCTeamTable(props) {
    ...
    for (let i = 1; i <= 10; i++) {
        ...
        golfers.push([
            ...
            ((props.info['G' + i + 'Pos'] === "CUT" || props.info['G' + i + 'Pos'] === "WD" || props.info['G' + i + 'Pos'] === "DQ") && (props.info["R2"] !== "-"))  ? null : props.info['G' + i + 'Thru'].includes("M") ? props.info['G' + i + 'Thru'] : props.info['G' + i + 'Today'] + ' (' + props.info['G' + i + 'Thru'] + ')',
        ])
    }
    return (
