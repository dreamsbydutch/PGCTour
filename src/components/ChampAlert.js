        ...
        <>
            <a href={"#/leaderboard/" + props.tourney.tourneyID + "?tour=dbyd"}>
                <div className='grid grid-flow-row grid-cols-10 text-center py-3 mb-8 bg-amber-100 rounded-2xl hover:text-amber-900 max-w-screen-md mx-auto shadow-md'>
                    ...
                    <div className="text-center font-varela place-self-center py-1 px-1 col-span-4 row-span-2 font-bold text-xl text-amber-900 xs:text-2xl sm:text-3xl">{leaderboards[1][0].Name}{littlefucker(props.data.standings.filter(obj => obj.TeamName === leaderboards[1][0].Name)[0],props.data.allTourneys)}</div>
            ...
            <a href={"#/leaderboard/" + props.tourney.tourneyID + "?tour=pgc"}>
                <div className='grid grid-flow-row grid-cols-10 text-center py-3 mb-8 bg-amber-100 rounded-2xl hover:text-amber-900 max-w-screen-md mx-auto shadow-md'>
                    ...
                    <div className="text-center font-varela place-self-center py-1 px-1 col-span-4 row-span-2 font-bold text-xl text-amber-900 xs:text-2xl sm:text-3xl">{leaderboards[0][0].Name}{littlefucker(props.data.standings.filter(obj => obj.TeamName === leaderboards[0][0].Name)[0],props.data.allTourneys)}</div>
