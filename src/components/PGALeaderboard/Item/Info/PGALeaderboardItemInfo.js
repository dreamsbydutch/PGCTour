...
function PGALeaderboardItemInfo(props) {
    return (
        <div className="pga-leaderboarditem-info-container">
            <div className="pga-leaderboarditem-info-container-row pga-leaderboarditem-info-labelrow">
            ...
            <div className="pga-leaderboarditem-info-container-row pga-leaderboarditem-info-roundrow">
                ...
                <div className="pga-leaderboarditem-info-total">{props.info.Tot}</div>
            </div>
        </div>
    )
}
