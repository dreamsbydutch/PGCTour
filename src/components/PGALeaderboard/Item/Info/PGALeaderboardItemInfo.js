...
function PGALeaderboardItemInfo(props) {
    return (
        <div className="pga-leaderboarditem-info-container">
            ...
            <div className="pga-leaderboarditem-info-roundone">{props.info.R1Score}</div>
            <div className="pga-leaderboarditem-info-roundtwo">{props.info.R2Score}</div>
            <div className="pga-leaderboarditem-info-roundthree">{props.info.R3Score}</div>
            <div className="pga-leaderboarditem-info-roundfour">{props.info.R4Score}</div>
            <div className="pga-leaderboarditem-info-total">{props.info.TotalScore}</div></div>
    )
}
