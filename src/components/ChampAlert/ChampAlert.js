    ...
    return (
        <a href={"#/leaderboard/" + props.tourney.tourneyID}>
            <div className='grid grid-flow-row grid-cols-10 text-center py-3 mb-8 bg-amber-200 rounded-2xl hover:text-amber-900 max-w-screen-md mx-auto shadow-md'>
                ...
                <div className="text-center font-varela place-self-center py-2 px-1 col-span-4 row-span-2 font-bold text-xl text-amber-900 xs:text-2xl sm:text-3xl md:text-4xl">{props.tourney.pgcLeaderboard[0].Name}</div>
